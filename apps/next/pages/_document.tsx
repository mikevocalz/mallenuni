  ...
  render() {
    ...
    return (
      <Html lang="en">
        ...
        <body className="scrollbar-thin scrollbar-thumb-[#662d91] scrollbar-track-[#94268f] scrollbar-thumb-rounded-full scrollbar-track-rounded-full h-32 overflow-x-hidden bg-white">
          <Main />
          <NextScript />
        </body>
      </Html>
