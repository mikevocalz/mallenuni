...
const SideBar: FC<any> = (props) => {
  ...
  return (
    <>
      ...
      >
        <Nav className="flex-1 px-[100px] items-start z-30 w-screen min-h-full opacity-100 border-l-[0.5px] ease-in-out duration-400  border-black max-w-[400px] bg-white p-10 pt-[130px] top-0 right-0 bottom-0 fixed"
        // style={{
        //   width: '7%',
        //   gap: 8,
        //   maxWidth: 360
